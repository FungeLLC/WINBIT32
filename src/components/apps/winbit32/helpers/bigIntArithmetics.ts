import { BaseDecimal } from "@swapkit/sdk";
...
export class BigIntArithmetics {
  ...
  constructor(params: SKBigIntParams) {
    ...
    console.log("in bigIntArithmetics.ts, BigIntArithmetics constructor, this.decimalMultiplier: ", this.decimalMultiplier, params);
...
function getFloatDecimals(value: string) {
 ...
 // return Math.max(decimals, DEFAULT_DECIMAL); //Why the blimmin heck is this returning 8 when some are 6? FFS.
    return Math.max(decimals, 6);
}
